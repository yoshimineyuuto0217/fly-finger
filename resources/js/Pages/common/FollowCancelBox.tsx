...
const FollowCancelBox = ({onClick,onConfirm}:{onClick:()=>void;onConfirm:()=>void;}) => {
    return (
        <>
            <div className="fixed bg-white w-[25%] h-auto pt-6  top-1/2 -translate-x-1/2 left-1/2 -translate-y-1/2 rounded-xl z-20 flex flex-col justify-between">
                ...
                <div className="flex w-full border-t ">
                    ...
                    <p className="w-[50%] text-center hover:bg-gray-200 py-2 hover:cursor-pointer rounded-br-xl" onClick={onConfirm}>フォロー解除</p>
                </div>
            </div>
        </>
    );
